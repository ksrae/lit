 ...
 */
const T = globalThis, k = T.ShadowRoot && (T.ShadyCSS === void 0 || T.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Y = Symbol(), I = /* @__PURE__ */ new WeakMap();
let ot = class {
  constructor(t, e, s) {
...
const ht = (r) => new ot(typeof r == "string" ? r : r + "", void 0, Y), lt = (r, t) => {
  if (k)
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: at, defineProperty: ct, getOwnPropertyDescriptor: dt, getOwnPropertyNames: pt, getOwnPropertySymbols: $t, getPrototypeOf: ut } = Object, f = globalThis, W = f.trustedTypes, _t = W ? W.emptyScript : "", M = f.reactiveElementPolyfillSupport, b = (r, t) => r, D = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? _t : null;
      break;
  ...
  return e;
} }, tt = (r, t) => !at(r, t), V = { attribute: !0, type: String, converter: D, reflect: !1, hasChanged: tt };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w = globalThis, N = w.trustedTypes, q = N ? N.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, et = "$lit$", _ = `lit$${(Math.random() + "").slice(9)}$`, st = "?" + _, ft = `<${st}>`, y = document, P = () => y.createComment(""), U = (r) => r === null || typeof r != "object" && typeof r != "function", it = Array.isArray, At = (r) => it(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", L = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, J = /-->/g, K = />/g, A = RegExp(`>|${L}(?:([^\\s"'>=/]+)(${L}*=${L}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Z = /'/g, F = /"/g, rt = /^(?:script|style|textarea|title)$/i, mt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), yt = mt(1), v = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), G = /* @__PURE__ */ new WeakMap(), m = y.createTreeWalker(y, 129);
function nt(r, t) {
...
const gt = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    ...
    for (; $ < h.length && (n.lastIndex = $, p = n.exec(h), p !== null); )
      $ = n.lastIndex, n === S ? p[1] === "!--" ? n = J : p[1] !== void 0 ? n = K : p[2] !== void 0 ? (rt.test(p[2]) && (i = RegExp("</" + p[2], "g")), n = A) : p[3] !== void 0 && (n = A) : n === A ? p[0] === ">" ? (n = i ?? S, l = -1) : p[1] === void 0 ? l = -2 : (l = n.lastIndex - p[2].length, c = p[1], n = p[3] === void 0 ? A : p[3] === '"' ? F : Z) : n === F || n === Z ? n = A : n === J || n === K ? n = S : (n = A, i = void 0);
    const u = n === A && r[a + 1].startsWith("/>") ? " " : "";
    o += n === S ? h + ft : l >= 0 ? (s.push(c), h.slice(0, l) + et + h.slice(l) + _ + u) : h + _ + (l === -2 ? a : u);
  }
...
var Ut = Object.defineProperty, xt = Object.getOwnPropertyDescriptor, Ht = (r, t, e, s) => {
